...
#SBATCH -t 80:00:00                      # The time the job will take to run.
...
R CMD BATCH --no-save --vanilla run_habanero_models_counterfactuals_strategy.R output_habanero_model_counterfactuals_strategy
