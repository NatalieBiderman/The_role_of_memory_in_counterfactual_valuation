...
#SBATCH -t 150:00:00                     # The time the job will take to run.
...
R CMD BATCH --no-save --vanilla habanero_model_counterfactuals.R output_habanero_model_counterfactuals
